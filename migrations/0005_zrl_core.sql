...
CREATE TABLE IF NOT EXISTS zrl_team_standings (
    ...
    r5 TEXT, r6 TEXT, r7 TEXT, r8 TEXT,
...
-- ============================================
-- INDEXES (opzionali ma consigliati)
-- ============================================
CREATE INDEX IF NOT EXISTS idx_round_groups_series
ON zrl_round_groups(series_id);

CREATE INDEX IF NOT EXISTS idx_team_standings_round
ON zrl_team_standings(round_group_id);

CREATE INDEX IF NOT EXISTS idx_races_round_group
