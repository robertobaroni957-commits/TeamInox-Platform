...
-- 1. Round Group
INSERT INTO zrl_round_groups (id, series_id, round_index, external_season_id, description, round_index_in_season, custom_round_group_id)
...
-- 3. Races (Using ID 105 which exists in rounds table)
INSERT INTO zrl_races (id, zrl_round_group_id, name, date, world, route)
VALUES (105, 1, 'Race 1', '2025-04-07', 'FRANCE', 'Hell of the North');

-- 4. MVPs (Using round_id 105 to satisfy FK to rounds table)
INSERT INTO division_results (round_id, rider_name, team_name, points_total, position, league_key, is_inox)
VALUES (105, 'Andrea Cerri', 'INOXTEAM ELITE', 85, 1, '10A10', 1);
INSERT INTO division_results (round_id, rider_name, team_name, points_total, position, league_key, is_inox)
VALUES (105, 'Cristian Collesei', 'INOXTEAM ELITE', 78, 2, '10A10', 1);
