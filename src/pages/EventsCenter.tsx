...
import { Calendar, Clock, ExternalLink, Loader2, Plus, Edit2, Trash2, X, Save } from 'lucide-react';
            ...
            <div className="p-8 flex-1">
              <div className="flex justify-between items-start mb-6">
                <div>
                  ...
                  <span className="text-white font-black text-xs uppercase flex items-center gap-2"><Clock size={12} /> {event.time} CET</span>
                </div>
                {canManage && (
              ...
              <p className="text-zinc-500 text-sm italic">{event.description || 'Nessuna descrizione.'}</p>
            </div>
